...
/// <summary>
/// An extension to the ActionBasedSnapTurnProvider that allows to toggle reading input of the left and the right controllers separately
/// </summary>
public class SnapTurnProviderExtension : ActionBasedSnapTurnProvider
{
    ...
    protected override Vector2 ReadInput() {
        ...
        var leftHandValue = m_useLeftHand ? (leftHandSnapTurnAction.action?.ReadValue<Vector2>() ?? Vector2.zero) : Vector2.zero;
        var rightHandValue = m_useRightHand ? (rightHandSnapTurnAction.action?.ReadValue<Vector2>() ?? Vector2.zero) : Vector2.zero;
