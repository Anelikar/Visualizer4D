...
/// <summary>
/// An extension to the ActionBasedContinuousTurnProvider that allows to toggle reading input of the left and the right controllers separately
/// </summary>
public class ContiniousTurnProviderExtension : ActionBasedContinuousTurnProvider
{
    ...
    protected override Vector2 ReadInput() {
        ...
        var leftHandValue = m_useLeftHand ? (leftHandTurnAction.action?.ReadValue<Vector2>() ?? Vector2.zero) : Vector2.zero;
        var rightHandValue = m_useRightHand ? (rightHandTurnAction.action?.ReadValue<Vector2>() ?? Vector2.zero) : Vector2.zero;
